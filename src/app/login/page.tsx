...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.response?.data?.errors?.[0] || 'Login failed. Please try again.')
    } finally {
      setIsLoading(false)
    }
  }
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark flex">
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-background-dark via-background-dark to-primary/20 p-12 flex-col justify-between">
        <div className="flex items-center gap-3">
          <div className="bg-primary rounded-lg p-3 flex items-center justify-center">
            <span className="material-symbols-outlined text-background-dark font-bold text-2xl">rocket_launch</span>
          </div>
          <div>
            <h1 className="text-white font-bold text-2xl leading-none">Africa-Freelance</h1>
            <p className="text-primary text-sm mt-1">Connecting Africa's Talent</p>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <p className="text-white font-bold">Trusted by 10,000+ Businesses</p>
                <p className="text-white/60 text-sm">Across 30+ African Countries</p>
              </div>
            </div>
            <p className="text-white/80 text-sm leading-relaxed">
              "Africa-Freelance helped us find amazing developers for our fintech startup. 
              The escrow system gave us peace of mind throughout the project."
            </p>
            <div className="flex items-center gap-3 mt-4">
              <div className="w-10 h-10 rounded-full bg-slate-300 flex items-center justify-center font-bold text-slate-700">AO</div>
              <div>
                <p className="text-white font-semibold text-sm">Amara Okafor</p>
                <p className="text-white/60 text-xs">CTO, PayFlow Technologies</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center border border-white/10">
              ...
              <p className="text-white/60 text-xs mt-1">Freelancers</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center border border-white/10">
              <p className="text-3xl font-black text-primary">$25M+</p>
              <p className="text-white/60 text-xs mt-1">Paid Out</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center border border-white/10">
        ...
        <div className="flex items-center gap-6 text-white/40 text-sm">
          <span>© 2024 Africa-Freelance</span>
          <span>•</span>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-slate-500 mt-2 mb-8">Sign in to your account to continue</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-primary text-background-dark font-bold py-4 rounded-xl hover:opacity-90 transition-all shadow-lg shadow-primary/20 flex items-center justify-center gap-2 disabled:opacity-50"
            >
              {isLoading ? (
                <>
